        ...
        <div className={style.content}>
           ...
           <div className={style.articles}>
            {articles.map(n => {
              ...
              <a href={`/offers/${n.offer.id}`}><img src={n.offer.imgURL || bannericon} className={style.banner}/></a>
              <a className={style.info} href={`/offers/${n.offer.id}`}>
                <div className={style.adress}>{n.offer.adress} {n.requests.rentTime ? `(Аренда на ${n.requests.rentTime} д.)` : null}</div>
